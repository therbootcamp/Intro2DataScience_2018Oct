...
```{r}
mcdonalds <- read_csv("1_Data/mcondalds.csv")
```
...
1. Make this plot (hint: use `scale_color_gradient(low = "green", high = "red") `)
...
2. Make this plot (hint: take the log of price with `log(price)`)
