...
| Package| Description| 
|:------|:------------|
| [`stats`](https://www.rdocumentation.org/packages/stats/versions/3.5.1)  | Linear, generalized linear models, individual tests, and all the distributions in the world.|
...
<br><br>
<p align = "center">
<img src="https://discourse-cdn-sjc1.com/business6/uploads/analyticsvidhya/143/8d72f17e0b2a743d.png" height = 500><br>
...
| [`mcmc`](https://cran.r-project.org/web/packages/mcmc/index.html)| Random-walk Metropolis algorithm. |
| [`bridgesampling`](https://cran.r-project.org/web/packages/mcmc/index.html)| Estimating marginal likelihoods, Bayes factors, etc. using bridgesampling. |
...
<p align="center"><br><br><iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeWa5uwZqD7O_jj5h59UFCR-iqrLmFdbc37untHUVbwRUrXWw/viewform?embedded=true" width="430" height="550">Wird geladen...</iframe></p>
...
<img src="https://therbootcamp.github.io/assets/img/statistics3.png" height="260px" width="480px"></img>
