...
A <high>social graph</high> of package Co-authors using [`tidyverse`](https://cran.r-project.org/web/packages/tidyverse/index.html) plus [`igraph`](https://cran.r-project.org/web/packages/igraph/index.html) and [`ggraph`](https://cran.r-project.org/web/packages/ggraph/index.html), an extension for [`ggplot2`](https://cran.r-project.org/web/packages/ggplot2/index.html) for graphs (aka networks) and `igraph`, an extremely powerful network analysis library. Find the code and additional explanation [here](https://www.r-bloggers.com/exploring-the-cran-social-network/).
